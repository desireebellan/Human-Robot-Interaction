...
from emotion_recognition.config import N, test_size
...
def load_emotion_data():
    df = pd.read_csv(dir_+"data/text_emotion.csv")
    additional_anger = read_text_file(dir_+"data/anger.txt")
    ...
    pickle.dump(vocab2int, open(dir_+"data/vocab2int.pickle", "wb"), protocol=2)
