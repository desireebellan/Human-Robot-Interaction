...
class GazeController(object):
    ...
    def async_detect_gestures(self):
        result = call_python_version("3.6", "vision_pepper_slave", "async_detect_gestures_proxy", ["Hand tracking", "done"]) 
        print(result)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--trackhands", type=bool, default=False,
                        help="Robot behaviour: recognize gestures.")
