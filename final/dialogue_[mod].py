...
def background_service(sr, filename):
	sr.speech2Text(filename)
...
class Dialogue(object):
	...
	def start(self):
		...
		# Receive answer
		#answer = self.sr.speech()
		self.audio_filename = './start_username.wav'
		t = Thread(target=background_service, args=(self.sr, self.audio_filename)) #answer = text()
		t.start()
		#t.join()
